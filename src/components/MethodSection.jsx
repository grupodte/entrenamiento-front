  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex items-center justify-center min-h-[350px] sm:min-h-[320px] md:min-h-[380px] px-4 sm:px-8 md:px-12">
        <div className="mt-[100px] bg-[#9580A6] px-5 sm:px-8 md:px-10 py-4 sm:py-6 md:py-7 shadow-[0_18px_40px_rgba(0,0,0,0.25)]  text-center rounded-[8px] sm:rounded-[12px] md:rounded-[16px]">
          <p className="m-0 text-[26px] sm:text-[34px] md:text-[52px] font-bold leading-none text-white">
            No fallaste vos.
          </p>
          <p className="m-0 text-[26px] sm:text-[34px] md:text-[52px] font-bold leading-none text-white/70">
            Falló el método.
          </p>
        </div>
      </div>
